<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Modifier la technologie: {{ $technology->name_fr }}
        </h2>
    </x-slot>
                    ...
                    <form action="{{ route('admin.technologies.update', $technology) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="name_fr" id="name_fr" value="{{ old('name_fr', $technology->name_fr) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="name_en" id="name_en" value="{{ old('name_en', $technology->name_en) }}" required
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                @if($technology->image_landscape)
                                    <div class="mt-2 mb-3">
                                        ...
                                        <img src="{{ asset($technology->image_landscape) }}" alt="{{ $technology->name_fr }} - Landscape" class="h-32 w-auto object-cover rounded-lg border-2 border-gray-200">
                                    </div>
                                @endif

                                <input type="file" name="image_landscape" id="image_landscape" accept="image/jpeg,image/png,image/jpg"
                                ...
                                <p class="mt-1 text-xs text-gray-500">Formats acceptés: JPEG, PNG, JPG. Taille max: 2 MB. Laissez vide pour conserver l'image actuelle.</p>
                            ...
                            <div>
                                ...
                                @if($technology->image_portrait)
                                    <div class="mt-2 mb-3">
                                        <p class="text-sm text-gray-600 mb-2">Image actuelle:</p>
                                        <img src="{{ asset($technology->image_portrait) }}" alt="{{ $technology->name_fr }} - Portrait" class="h-32 w-auto object-cover rounded-lg border-2 border-gray-200">
                                    </div>
                                @endif

                                <input type="file" name="image_portrait" id="image_portrait" accept="image/jpeg,image/png,image/jpg"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea name="description_fr" id="description_fr" rows="6" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('description_fr') border-red-500 @enderror">{{ old('description_fr', $technology->description_fr) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="description_en" id="description_en" rows="6" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('description_en') border-red-500 @enderror">{{ old('description_en', $technology->description_en) }}</textarea>
