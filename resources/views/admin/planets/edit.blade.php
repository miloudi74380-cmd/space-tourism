<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Modifier la planète: {{ $planet->name_fr }}
        </h2>
    </x-slot>
                    ...
                    <form action="{{ route('admin.planets.update', $planet) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="name_fr" id="name_fr" value="{{ old('name_fr', $planet->name_fr) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="name_en" id="name_en" value="{{ old('name_en', $planet->name_en) }}" required
                        ...
                        <div>
                            ...
                            @if($planet->image)
                                <div class="mt-2 mb-3">
                                    ...
                                    <img src="{{ asset($planet->image) }}" alt="{{ $planet->name_fr }}" class="h-32 w-32 object-cover rounded-lg border-2 border-gray-200">
                                </div>
                            @endif
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea name="description_fr" id="description_fr" rows="4" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('description_fr') border-red-500 @enderror">{{ old('description_fr', $planet->description_fr) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="description_en" id="description_en" rows="4" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('description_en') border-red-500 @enderror">{{ old('description_en', $planet->description_en) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="distance_fr" id="distance_fr" value="{{ old('distance_fr', $planet->distance_fr) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="distance_en" id="distance_en" value="{{ old('distance_en', $planet->distance_en) }}" required
                                    placeholder="384,400 km"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="travel_fr" id="travel_fr" value="{{ old('travel_fr', $planet->travel_fr) }}" required
                                    placeholder="3 jours"
                            ...
                            <div>
                                ...
                                <input type="text" name="travel_en" id="travel_en" value="{{ old('travel_en', $planet->travel_en) }}" required
                                    placeholder="3 days"
